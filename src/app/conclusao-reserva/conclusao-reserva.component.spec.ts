...
describe('ConclusaoReservaComponent', () => {
  ...
  it('deve exibir o título e a mensagem de confirmação', () => {
    const title = fixture.debugElement.query(By.css('.confirmation-title'))
      .nativeElement.textContent;
    const message = fixture.debugElement.query(By.css('.confirmation-message'))
      .nativeElement.textContent;
  ...
  it('deve ter um link de voltar', () => {
    const backButton = fixture.debugElement.query(By.css('.back-link'))
      .nativeElement.textContent;
